...
## Stack
Game based on MVVM pattern (currently migrating from the MVP architecture) and event-driven approach for game systems communications.
Using self-written DI-framework (very simple, in future planned migrate to VContainer)
